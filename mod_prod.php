                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <h4 class="mb-0"><strong>MODIFICATION PRODUIT DE LINGE EN STOCK</strong></h4>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <?php
                                            ...
                                            $pdoStat = $ojetPdo->prepare('UPDATE produit set nom=:nom,  

                                            prix_prod=:prix_prod, stock=:stock, date=:date WHERE id=:num LIMIT 1');

                                            $pdoStat->bindvalue(':num',$_POST['numProduit'],PDO::PARAM_INT);

                                            $pdoStat->bindvalue(':nom',$_POST['nom'],PDO::PARAM_STR);

                                            $pdoStat->bindvalue(':prix_prod',$_POST['prix_prod'],PDO::PARAM_INT);
                                                    ...
                                                    "
                                                        ...
                                                        <div style='text-align: center'>
                                                            <span class='alert alert-success' >
                                                                <strong>
                                                                    Le produit a bien été modifier avec succès !!
                                                                </strong>
                                                            </span>
                                                        </div>";
                                                ...
                                                echo
                                                    ...
                                                    <div style='text-align: center'>
                                                        <span class='alert alert-danger' >
                                                            <strong>
                                                                Echec de modification du produit de linge !!
                                                            </strong>
                                                        </span>
                                                    </div>";
                                            }
