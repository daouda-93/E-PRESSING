                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <h4 class="mb-0"><strong>MODIFIER LES PRODUITS DE LINGE EN STOCK</strong></h4>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="admin.php" class="breadcrumb-link">Tableau Bord Buanderie</a></li>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <h4 class="mb-0"><strong>Modification des informations de produit</strong></h4> 
                                        </div>

                                        <div class="card-body">
                                            <form method="post" action="mod_prod.php">
                                                <div class="row">
                                                <div class="offset-xl-3 col-xl-6 offset-lg-3 col-lg-3 col-md-12 col-sm-12 col-12 p-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name">Prix Produit (CFA)</label>
                                                        <input class="form-control" type="number" name="prix_prod"  value="<?= $contact['prix_prod']; ?>" required="">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="date" name="date"  value="<?= $contact['date']; ?>"  required="">
                                                    </div>
                                                    
                                                        <button class="btn btn-primary btn-lg btn-block" name="btn_prod" type="submit">MODIFIER</button>
                                                    </div>
                                                </div>
                                                </div>
                                            </form> 
