                            ...
                            <div class="page-breadcrumb">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Notifications reçu</li>
                                    </ol>
                                </nav>
                                </div>
                            </div>
                    ...
                    <div id="div1">
                        <div class="card">
                            <div class="card-header" align="center">
                                ...
                                </h5>liste des notifications reçus</h5> 
                            </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <?php
                                        ...
                                        while ($data = $req->fetch(PDO::FETCH_OBJ)):?>
                                            ...
                                            <p  class="<?php echo ($data->lu) ? 'alert alert-success' : 'alert alert-danger';?>">
                                                ...
                                                <a href="read.php?id=<?php echo $data->id;?>"> <button class="btn btn-danger">marquer comme lu</button></a>
