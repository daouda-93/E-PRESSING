                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="page-breadcrumb">
                                <h5 class="pageheader-title">NOTIFICATIONS DE LA BUANDERIE</h5>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="admin.php" class="breadcrumb-link">Tableau Bord Admin</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Notifications envoyé</li>
                                    </ol>
                                </nav>
                                </div>
                            </div>
                    ...
                    <div id="div1">
                        <div class="card">
                            <div class="card-header" align="center">
                                ...
                                </h5>liste des notifications envoyés par la buanderie</h5> 
                            </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="table-responsive">
                                    <?php
                                        ...
                                        while ($data = $req->fetch(PDO::FETCH_OBJ)):?>
                                            ...
                                            <small style="color: blue">Envoyé le : <?php echo $data->date;?> &nbsp; &nbsp;<a href="sup_msg.php?numContact=<?php echo $data->id;?>" ><strong style="color: red">supprimer</strong></a></small>
