...
<?php
//selction de prix d'article dans combox
$connect = new PDO("mysql:host=localhost;dbname=p_experts", "root", "");
 ...
 <body>
    <div class="container">
        ...
        <div class="table-repsonsive">
            <span id="error"></span>
            <div class="row">
            <h2 align="center"><strong style="color: orange"><u>ENREGISTREMENT DE DEPOT DE LINGES DU CLIENT</u></strong></h2>
               ...
               <div class="col-md-6 mb-3">
                    <h3><a href="gerant.php"><Strong title="Retourner au tableau de bord">Tableu de Bord</strong></a></h3>
                    <h3 for="firstName" style="color: red"><strong>Client N° :</strong> <?= $contact['num_client']; ?></h3>
                    <h3 for="firstName"><strong>Nom et Prénoms :</strong> <?= $contact['nom_prenom']; ?></h3>
                </div></br>
...
$(document).ready(function(){
 ...
 $('#insert_form').on('submit', function(event){
        ...
        if($(this).val() == '')
        {
            error += "<p>Entrer le prix de l'article  </p>";
            return false;
        }
        count = count + 1;
        });
        ...
        if($(this).val() == '')
        {
            error += "<p>Entrer le nom de l'article pour le dépot  </p>";
            return false;
        }
        count = count + 1;
        });
        ...
        if($(this).val() == '')
        {
            error += "<p>Entrer la date de dépode de l'article  </p>";
            return false;
        }
        count = count + 1;
        });
        ...
        if($(this).val() == '')
        {
            error += "<p>Entrer la date de retrait de l'article </p>";
            return false;
        }
        count = count + 1;
        });
