                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header" align="center">
                                <h2 class="pageheader-title">INFORMATIONS SUR CLIENT</h2><hr>
                            </div>
                        </div>
                    </div>
                    <!-- ============================================================== -->
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post" action="mod_client.php">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="nom_prenom"  value="<?= $contact['nom_prenom']; ?>" >
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <label for="firstName">Adresse</label>
                                                        <input class="form-control" type="text" name="adresse"  value="<?= $contact['adresse']; ?>" >
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <label for="email">Téléphone</label>
                                                        <input class="form-control" type="number" name="telephone" value="<?= $contact['telephone']; ?>"  >
                                                    </div>

                                                    <div class="col-md-6 mb-3">
                                                        <label for="country">Genre Client</label>
                                                        <select class="custom-select d-block w-100" type="text" name="genre" required="">
                                                    ...
                                                    <div class="col-md-6 mb-3"> 
                                                        ...
                                                        <input class="form-control" type="date" name="date" value="<?= $contact['date']; ?>"  >
                                                    </div>
