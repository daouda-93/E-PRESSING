                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                           <div class="page-header" align="center">
                                <h2 class="pageheader-title">ENCAISSEMENT DE LA SOMME DU FACTURE</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="gerant.php" class="breadcrumb-link">Tableau Bord Gerent</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Encaissement de la somme</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            if(isset($_POST['btn_paye']))
                                                {
                                                        ...
                                                        $statut_paie = $_POST["statut_paie"];

                                                        
                                                        $query = "INSERT  INTO regle_facture (id_facture, id_client, total_payer, total_remise, net_payer, statut_paie, createdAt) 
                                                        
                                                        VALUES ('$id_facture', '$id_client', '$total_payer', '$total_remise', '$net_payer', '$statut_paie', now() ) ";
                                                            ...
                                                            echo
                                                                ...
                                                                <div style='text-align: center'>
                                                                    <span class='alert alert-success' >
                                                                        <strong>
                                                                            L'encaissement de la somme du facture a été effectué avec succes !!
                                                                        </strong>
                                                                    </span>
                                                                </div>";
                                                            ...
                                                            echo
                                                                ...
                                                                <div style='text-align: center'>
                                                                    <div class='alert alert-danger'>
                                                                        L'encaissement de la somme du facture client a échoué !!
                                                                    </div> 
                                                                </div>";
                                                        }
                                                }
