...
<body>
    ...
    <script>
        ...
        var html = '';
            ...
            html += '<tr>';
            // html += '<td><select name="item_article[]" class="form-control item_article"><option value="">Choisir ...</option></select></td>';
            ...
            html += '<td><input type="text" name="item_prix[]" class="form-control item_prix" /></td>';
            // html += '<td><select name="item_prix[]"  class="form-control item_prix"><option value="">Choisir ...</option></select></td>';
        ...
        if($(this).val() == '')
        {
            error += "<p>Entrer le nom d'article pour le dépot  </p>";
            return false;
        }
        count = count + 1;
        });
