                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header" align="center">
                                ...
                                <h5 class="pageheader-title">LINGES RETIRE PAR LES CLIENTS</h5>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="gerant.php" class="breadcrumb-link">Tableau Bord Gerent</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Liste des linges rétirés</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                ...
                                <?php
                                    ...
                                    while ($data = $req->fetch(PDO::FETCH_OBJ)):?>
                                        ...
                                        <p  class="<?php echo ($data->lu) ? 'alert alert-success' : 'alert alert-danger';?>">
                                            ...
                                            <?php echo  "Avoir retiré son linge";?>
