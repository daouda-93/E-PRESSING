                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header" align="center">
                                <h2 class="pageheader-title">LISTE DES LINGES EN TRAITEMENT</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="admin.php" class="breadcrumb-link">Tableau Bord Admin</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Linges en traitement à la buanderie</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div id="div1">
                        <div class="card">
                            <div class="card-header" align="center">
                                ...
                                </h5>liste des linges en tratiement à la buanderie</h5> 
                            </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <?php
                                    ...
                                    while ($data = $req->fetch(PDO::FETCH_OBJ)):?>
                                       ...
                                       <p  class="<?php echo ($data->lu) ? 'alert alert-success' : 'alert alert-danger';?>">
                                            ...
                                            <?php echo  "Linge en traitement au niveau de la buanderie";?>
